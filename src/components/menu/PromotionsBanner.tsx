    ...
    <div className="relative overflow-hidden">
      ...
      <button
        ...
        className={cn(
          ...
          "transition-all duration-300 hover:from-primary hover:to-primary/90",
          "shadow-sm"
        )}
      >
        <div className="flex items-center gap-2 min-w-0 flex-1">
          <Sparkles className="w-4 h-4 flex-shrink-0 animate-pulse" />
          <span className="px-2 py-0.5 bg-white/20 rounded-full text-xs font-medium flex-shrink-0">
      ...
      <div
        className={cn(
          "overflow-hidden transition-all duration-300 ease-in-out bg-gradient-to-b from-primary/5 to-transparent",
